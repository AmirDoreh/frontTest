# Ada Kapital Front-end Developer Coding Test
...
- JS oriented
  ...
  - _Do not_ use any React/Angular boilerplate, such as Create React App ...
- Feel free to use a preprocessor like SASS/SCSS/Less 
